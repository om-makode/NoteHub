      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">The NoteHub Website redefines the way we manage and share study materials. </p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <div class="container">
              <form role="form text-left" id="contactform" method="POST">


                <div class="mb-3">

                   <input id="name" class="form-control" name="name" placeholder="Name" required="" tabindex="1" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['name']; } ?>"> 

                </div>


                <div class="mb-3">
                  <input id="username" class="form-control" name="username" placeholder="Username"  required="" tabindex="2" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['username']; } ?>"> 
                </div>


                <div class="mb-3">
                  <input id="email" class="form-control" name="email" placeholder="Email"  required="" type="email" value="<?php if(isset($_POST['signup'])) { echo $_POST['email']; } ?>"> 
            ...
            <option value="Civil">Civil</option>
              ...
              <!--   <p class="contact"><label for="semester">Semester</label></p>
                  <div class="mb-3">
            ...
            <option value="8th">8th</option>
                ...
                <div>
                 ...
                 <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" name="signup" id="submit" tabindex="5" value="Sign me up!">Sign Up</button>
                 </div>

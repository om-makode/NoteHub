  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/uploadnotes.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Upload Notes</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Upload Notes</h6>
        </nav>
...
if($validated_data === false) {
    ...
    $file_title = $validated_data['title'];
      ...
      $subjectname = $validated_data['sname'];
...
echo "<script>alert('file size is not proper');</script>";
       ...
       $subjectname;
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'], $folder.$notefile)) {
            $query = "INSERT INTO uploads(subject_name,file_name, file_description, file_type, file_uploader, file_uploaded_to, file) VALUES ('$subjectname','$file_title' , '$file_description' , '$fileext' , '$file_uploader' , '$file_uploaded_to' , '$notefile')";
            $result = mysqli_query($conn , $query) or die(mysqli_error($conn));
            if (mysqli_affected_rows($conn) > 0) {
                echo "<script> alert('file uploaded successfully.It will be published after admin approves it');
                window.location.href='uploadnotes.php';</script>";
            }
            else {
...
?>
     ...
     <form role="form" action="" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
             <p class="contact"><label for="post_title">Subject</label></p>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        <label for="post_image">Select File</label><font color="brown"> (allowed file type: 'pdf','doc','ppt','txt','zip' | allowed maximum size: 30 mb ) </font><br>
